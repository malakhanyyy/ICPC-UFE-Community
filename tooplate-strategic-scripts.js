...
mobileMenu.addEventListener('click', () => {
   ...
   mobileMenu.classList.toggle('active'); // Simply toggle the class
});
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [{
            h1: "Where problem solvers are built",
            p: "At ICPC-UFE Community, we believe that great problem solvers are not born — they are built through practice, guidance, and the right mindset."
         },
         {
            h1: "Your ICPC journey starts here",
            p: "Our community is designed to help students develop strong analytical thinking, master competitive programming skills, and approach challenges with confidence."
         },
         {
            h1: "Learn Together, Grow Together",
            p: "Through structured training, real contest-style problems, and continuous mentorship, we prepare our members to think logically and code efficiently."
         }
      ];
